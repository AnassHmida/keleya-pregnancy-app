...
module.exports = {
  ...
  apps: {
    ...
    'ios.release': {
      ...
      build: 'xcodebuild -workspace ios/KeleyaPregnancyApp.xcworkspace -scheme KeleyaPregnancyApp -configuration Release -sdk iphonesimulator -derivedDataPath ios/build'
    },
    'android.debug': {
      type: 'android.apk',
